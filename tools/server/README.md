...
| `-cpent, --checkpoint-every-n-tokens N` | create context checkpoints every N prompt tokens during prefill (default: -1, <= 0 disables periodic scheduling)<br/>(env: LLAMA_ARG_CHECKPOINT_EVERY_NT) |
